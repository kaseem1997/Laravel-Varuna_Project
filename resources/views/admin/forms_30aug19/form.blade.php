@component('admin.layouts.main')
    ...
    $IMG_HEIGHT = CustomHelper::WebsiteSettings('FORM_IMG_HEIGHT');
    $IMG_WIDTH = CustomHelper::WebsiteSettings('FORM_IMG_WIDTH');
...
<div class="input_box">
    ...
    <?php
    if(!empty($form_elements) && count($form_elements) > 0){
        foreach($form_elements as $fe){
