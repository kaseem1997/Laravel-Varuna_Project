        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                    <label for="sort_order" class="control-label {{ $image_required }}">Home Image (Max. width: {{$IMG_WIDTH}}px, Max. height: {{$IMG_HEIGHT}}px):</label>
                    ...
                    if($storage->exists($path.$image)){
                        ...
                        <div class="col-md-2 image_box">
                            <a href="{{ url('public/storage/'.$path.$image) }}" target="_blank">
                                <img src="{{ url('public/storage/'.$path.'thumb/'.$image) }}" style="width: 100px;">
                            </a>
                            <br>
