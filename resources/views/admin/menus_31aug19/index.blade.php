@component('admin.layouts.main')
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <h2>{{$title}}
                <a href="{{route($routeName.'.menus.add',['back_url'=>$back_url]) }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> {{$addBtn}}</a>
                    ...
                    <table class="table table-striped">
                        ...
                        foreach($forms as $form){
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route($routeName.'.forms.edit', [$form->id,'back_url'=>$back_url]) }}" title="Edit Blog"><i class="fas fa-edit"></i></a>
