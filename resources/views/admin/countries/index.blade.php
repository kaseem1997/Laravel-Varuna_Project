    ...
    <div class="row">
        <div class="col-md-12">
			<div class="titlehead">
			<h1 class="pull-left">Country List ({{ $res->count() }})</h1>

            <a href="{{ url($routeName.'/countries/save') }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add Country</a>
                ...
                <form class="form-inline" method="GET">
                   ...
                   <!--  <div class="clearfix"></div> -->
                    <div class="col-md-6">
                        ...
                        <a href="{{url('admin/countries')}}" class="btn resetbtn btn-primary btn1search">Reset</a>
                    </div>
                </form>
            </div>
        </div>
