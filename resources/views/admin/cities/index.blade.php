    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ url($routeName.'/cities/save') }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> Add City</a>
                ...
                <form class="form-inline" method="GET">
                   ...
                   <!--  <div class="clearfix"></div> -->
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="{{url($routeName.'/cities')}}" class="btn resetbtn btn-primary btn1search">Reset</a>
                    </div>
                </form>
            </div>
        </div>
