                        ...
                        foreach($forms as $form){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{ route($routeName.'.forms.delete', $form->id) }}" accept-charset="UTF-8" role="form" onsubmit="return confirm('Do you really want to remove this Form?');" id="delete-form-{{$form->id}}">
                                        {{ csrf_field() }}
                                        {{ method_field('POST') }}
