    ...
    @slot('title')
        ...
        Admin - Manage Case Study - {{ config('app.name') }}
    ...
    if(is_numeric($parent_id) && $parent_id > 0){
        $CategoryBreadcrumb = CustomHelper::CategoryBreadcrumb($parentCategory, 'admin/casestudy_categories?type='.$type, 'Case Study Categories');
    }
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <a href="{{ route($routeName.'.casestudy_categories.add', ['parent_id'=>$parent_id,'back_url'=>$BackUrl]) }}" class="btn btn-sm btn-success pull-right"><i class="fa fa-plus"></i> <?php echo $addBtn;?></a> 
                    ...
                    <div class="table-responsive">
                        ...
                        <form class="form-inline" method="GET">
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{url($routeName.'/casestudy_categories')}}" class="btn resetbtn btn-primary btn1search" >Reset</a>
                            </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="table-responsive">           
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    if(!empty($category->children) && $category->children->count() > 0 ){
                        ...
                        $child_url = 'casestudy_categories?&parent_id='.$category->id.'&back_url='.rawurlencode($BackUrl);
                        ...
                        <tr class="row_{{$category->id}}">
                            ...
                            <td>
                                ...
                                if($countParents < 2){
                                    ?>
                                    <a href="{{ route($routeName.'.casestudy_categories.add', ['parent_id'=>$category->id, 'back_url'=>$BackUrl]) }}" title="Add Child Category" ><i class="fas fa-plus"></i></a>
                                ...
                                <a href="{{route($routeName.'.casestudy_categories.edit', ['id'=>$category->id,'back_url'=>$BackUrl])}}" title="Edit"><i class="fas fa-edit"></i></a>
                                ...
                                <form method="POST" action="{{ route($routeName.'.casestudy_categories.delete', $category->id) }}" accept-charset="UTF-8" role="form" onsubmit="return confirm('Do you really want to remove this category?');" class="delForm">
