...
@include('common.head')
<style>.contactForm{margin-bottom:20px;}</style>
</head>
    ...
    <div class="rightBar">
      <div class="container-custom">
        <div class="panel panel-default"> 
          <div class="topHeading panel-heading"><span></span><span></span><span></span>{{trans('custom.contact_us')}}</div>
          ...
          <div class="panel-body">
            <div class="midText text-center">
              <h2><?php echo trans('custom.wed_to_help', ['icon'=>'<i class="fa fa-heart-o" aria-hidden="true"></i>'])?>!</h2>
            ...
            if(!empty($agent) && count($agent) > 0){
              ...
              ?>
               ...
               <strong>{{trans('custom.account_manager')}}:</strong> <span style="color: #686a78">{{$agent_name}}</span><br>
               <strong>{{trans('custom.contact')}}:</strong> <span style="color: #686a78">{{$agent_phone}}</span><br>
               </div>
               <hr>
              <?php
            }
              ...
              ?>
                ...
                <input type="hidden" name="agent_id" value="<?php echo $agent_id;  ?>"  >
                   ...
                   <div class="col-sm-6  {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <label for="inputEmail3" class="control-label">{{trans('custom.name')}} :</label>
                  ...
                  <div class="col-sm-6  {{ $errors->has('email') ? ' has-error' : '' }}">
                    <div class=" contactForm">
                    <label for="inputEmail3" class="control-label">{{trans('custom.email')}} :</label>
                  ...
                  <div class="col-sm-6 ">
                    <div class=" contactForm">
                    <label for="inputEmail3" class="control-label">{{trans('custom.phone')}} :</label>
                  ...
                  <div class="col-sm-6{{ $errors->has('option') ? ' has-error' : '' }}">
                    <div class="  contactForm" >
                               
                     <select name="option" class="form-control selectoption">

                     <option value="">{{trans('custom.choose_an_option')}}</option>
                      ...
                      if(count($contact_options)){
                        foreach($contact_options as $option_key=>$option_val){
                          ...
                          ?>
                          <option value="{{$option_key}}" {{$selected}}>{{trans('custom.'.$option_key)}}</option>
                          <?php
                        }
                      }
                      ?>
                  ...
                  <div class="col-sm-12 {{ $errors->has('message') ? ' has-error' : '' }}">
                    <div class="  contactForm">
                    <label for="inputEmail3" class="msg control-label">{{trans('custom.message')}} :</label>
                  ...
                  */
                  ...
                  <div class="col-sm-12">
                    <button class="btn btnSendNew btn-send btn-default" id="verify">{{trans('custom.send')}} <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button>
                  </div>
                </form>
              </div>
              <div class="col-md-6 paddingLeftLarge" style="padding-left:10px !important;">
                <?php
