    ...
    <body>
            ...
            <div class="contentArea">
                ...
                <input type="hidden" name="quantity" value="{{ $productCartQty }}" />
                            ...
                            <div class="mediaNew media">
                                ...
                                <a href="javascript:void(0)" class="btn btn-default pull-right" onclick="window.history.back();">Back</a>
                                <div class="media-body-new media-body">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 noPaddings itemPrice">
                                        <p>
                                        <i class="fa fa-inr" aria-hidden="true"></i> {{ $product_price }}/pc + GST @5%
                                        <?php
                    if($cross_price > 0){
                      ?>
                                    ...
                                    if(count($availableInventory) > 0){
                                       ...
                                       <div class="col-md-12 col-sm-12 col-xs-12 well">
                                        ...
                                        <div class="col-sm-6 col-xs-6 col-md-6">
                                            <p>Total:</p>
                                            <strong><img src="{{url('public/assets/img/rs.png')}}" alt="rs" style="width: 13px;position: relative;bottom: 3px;"/> <span class="totalPrice">{{ $productPriceFromCart }}</span></strong> </div>
                                    </div>
        ...
        function addToCart(){
            ...
            $('.btn-number').click(function(e){
                ...
                add_to_cart(fieldName, inventoryid);
            });
            ...
            function add_to_cart(fieldName, inventoryid){
