                ...
                <input type="hidden" name="quantity" value="{{ $productCartQty }}" />
                            ...
                            <div class="mediaNew media">
                                ...
                                <div class="media-body-new media-body">
                                    <h3>{{$product->name}}</h3>
                                    <span class="spans"> <img src="{{url('public/assets/img/qr.png')}}"/>Item Code : <strong>{{$product->code}}</strong> </span> <span class="spans right-spans"> <img src="{{url('public/assets/img/tag.png')}}"/>Brand : <strong>{{$brand_name}}</strong> </span>
                                    <hr>
