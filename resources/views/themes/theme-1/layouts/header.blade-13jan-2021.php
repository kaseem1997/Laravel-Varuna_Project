              ...
              <ul class="dropdown-menu dropdown-menu-cust dropdown__menu__box menu_flex_sec_wrap" aria-labelledby="navbarDropdown" >
                  ...
                  <div class="left_side_content">
                   ...
                   <ul class="menu_flex_sec">
                    ...
                    <a href="{{url('industry-healthcare')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/Pharma.png')}}" class="img-fluid" />
                      </div>
                      <div class="menuBoxText">
                        Pharma & Healthcare
                      </div>
                 ...
                 <li>
                    <a href="{{url('industry-fmcg')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/FMCD.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        FMCG
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-automotive')}}"  class="">
                       <div class="menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/Auto.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                       Auto Components and Tyres
                      </div>
                    ...
                    <a href="{{url('food-beverage')}}"  class="">
                       <div class="menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/Food.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Food & Beverage
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-electrical')}}"  class="">
                       <div class="menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/Electrical.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Electrical
                      </div>
                 ...
                 <li>
                    <a href="{{url('industry-omnichannel')}}">
                       <div class="menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/omnichannel.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Omnichannel Retail
                      </div>
