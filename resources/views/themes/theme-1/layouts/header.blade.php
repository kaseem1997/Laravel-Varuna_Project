        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg">
           <a class="customNavbar-toggler menu-icons open">Menu
             ...
             <a class="navbar-brand" href="/"><img class="img-fluid logo" src="{{asset('assets/themes/theme-1/images/logoNew.png')}}" alt="Varuna Group: 3PL Warehousing & Logistics Company"></a>
          ...
          <ul class="navbar-nav mr-auto customNav">
            <div class="nav-icons close">
              ...
              <li class="dropdown dropdownCust">
                <!-- <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('services')}}" > -->
                  <span class="arrow_down"><i></i></span>
               <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('services')}}" >
                Services 
              </a>
              <ul class="dropdown-menu dropdown-menu-cust three__box__menu">
                 <li>
                  ...
                  <li>
                   <a href="{{url('logistics-management-services')}}" class="whremrl20">
                     <!--img src="{{asset('/assets/themes/theme-1/images/subHeaderLogo.png')}}" class="img-fluid topMenuLogo" /-->
                       <p class="topMenuText">
                  ...
                  <li>
                    <a href="{{url('warehousing-management-services')}}">
                      <!--img src="{{asset('/assets/themes/theme-1/images/subHeaderLogo2.png')}}" class="img-fluid topMenuLogo" /-->
                        <p class="topMenuText">
                  ...
                  <!--li>
                    <a href="{{url('service-integrate')}}"  class="whremrr74">
                      <img src="{{asset('/assets/themes/theme-1/images/subHeaderLogo3.png')}}" class="img-fluid topMenuLogo" />
                        <p class="topMenuText">
            ...
            <li class="dropdown dropdownCust dropdown__box" style="display: none;">
               <span class="arrow_down"><i></i></span>
               <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('industry-solution')}}" >
                Industry Solutions
              </a>
              <ul class="dropdown-menu dropdown-menu-cust dropdown__menu__box">
                 <li>
                  <div class="left_side_content">
                    <a class="dropdown-item" href="#">
                      <h4 class="menuHeading menuPadding">
                       Our solutions
                        are tailored to your <span class="bannerNewLine"></span>
                  ...
                  <ul class="flex_menus">
                    ...
                    <a href="{{url('industry-healthcare')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/M-Pharmacy.png')}}" alt="Pharma & Healthcare" class="img-fluid" />
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-omnichannel')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/M-Omnichannel.png')}}" alt="Omnichannel Retail" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Omnichannel Retail
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-automotive')}}"  class="">
                       <div class="M__menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/M-Auto-Tyre.png')}}" alt="Auto Components and Tyres" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                    ...
                    <a href="{{url('food-beverage')}}"  class="">
                       <div class="M__menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/M-F-B.png')}}" alt="Food & Beverage" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Food & Beverage
                      </div>
                    ...
                    <a href="{{url('industry-electrical')}}"  class="">
                       <div class="M__menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/M-Electrical.png')}}" alt="Electrical" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Electrical
                      </div>
                    ...
                    <a href="{{url('industry-fmcg')}}">
                       <div class="M__menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/M-FMCG.png')}}" alt="FMCG" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        FMCG
                      </div>
            ...
            <li class="dropdown dropdownCust">
               <span class="arrow_down"><i></i></span>
                <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('capabilities')}}">
                Capabilities
                </a>
              <?php
              ...
              <ul class="dropdown-menu dropdown-menu-cust  centerMenu">
            ...
            <?php } ?>
              ...
              <li class="dropdown dropdownCust">
                 <span class="arrow_down"><i></i></span>
                <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('varuna-career')}}" >
                Careers
               
                </a>
              <ul class="dropdown-menu dropdown-menu-cust dropdownLink___nav centerMenu">
                ...
                <li><a class="dropdown-item" href="{{url('careers')}}">Open Positions</a></li>
              </ul>
            </li>

            <li class="dropdown dropdownCust">
                <span class="arrow_down"><i></i></span>
                <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('about')}}" >
                About Us
                </a>
          ...
          <ul class="navbar-nav mr-auto customNav">
              ...
              <ul class="dropdown-menu dropdown-menu-cust three__box__menu" aria-labelledby="navbarDropdown">
                 <li>
                  ...
                  <li>
                   <a href="{{url('logistics-management-services')}}" class="whremrl20">
                     <img src="{{asset('/assets/themes/theme-1/images/subHeaderLogo.png')}}" alt="Primary transport management  involving long haul trucking" class="img-fluid topMenuLogo" />
                       <p class="topMenuText">
                         Primary transport management <br /> involving long haul trucking
                       </p>
                    </a>
                  ...
                  <li>
                    <a href="{{url('warehousing-management-services')}}">
                      <img src="{{asset('/assets/themes/theme-1/images/subHeaderLogo2.png')}}" alt=" Warehousing operations & secondary transport management" class="img-fluid topMenuLogo" />
                        <p class="topMenuText">
            ...
            <li class="dropdown dropdownCust dropdownCustonhover dropdown__box" style="display: none;">
               <a class="dropdown-toggle dropdown-toggle-custom" href="{{url('industry-solution')}}" id="navbarDropdown"  data-toggle="dropdown">
                Industry Solutions
              </a>
              <ul class="dropdown-menu dropdown-menu-cust dropdown__menu__box menu_flex_sec_wrap" aria-labelledby="navbarDropdown" >
                 <li>
                  <div class="left_side_content">
                    <a class="dropdown-item" href="#">
                      <h4 class="menuHeading menuPadding">
                        Our solutions <span class="bannerNewLine"></span>
                        are tailored to  <span class="bannerNewLine"></span>
                        your specific business <span class="bannerNewLine"></span> needs
                       </h4>
                     </a>
                   </div>
                   <ul class="menu_flex_sec">
                      <li>
                    <a href="{{url('industry-healthcare')}}">
                      <div class="menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/Pharma.png')}}" alt="Pharma" class="img-fluid" />
                      </div>
                      <div class="menuBoxText">
                        Pharma & Healthcare
                      </div>
                 ...
                 <li>
                    <a href="{{url('industry-fmcg')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/FMCD.png')}}" alt="FMCD" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        FMCG
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-automotive')}}"  class="">
                       <div class="menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/Auto.png')}}" alt="Auto" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                       Auto Components and Tyres
                      </div>
                    ...
                    <a href="{{url('food-beverage')}}"  class="">
                       <div class="menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/Food.png')}}" alt="Food" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Food & Beverage
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-electrical')}}"  class="">
                       <div class="menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/Electrical.png')}}" alt="Electrical" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Electrical
                      </div>
                 ...
                 <li>
                    <a href="{{url('industry-omnichannel')}}">
                       <div class="menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/omnichannel.png')}}" alt="omnichannel" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Omnichannel Retail
                      </div>
            ...
            <li class="dropdown threeHed">
              <a class="dropdown-toggle dropdown-toggle-custom dropdown-user" href="http://trackntrace.varuna.net/trackntrace/login" target="_blank">
              V-Track & Trace
              </a>
              <ul class="dropdown-item" aria-labelledby="navbarDropdown" >
                <li><a class="dropdown-item" href="http://trackntrace.varuna.net/trackntrace/login">Customer Login</a></li>
                <li><a class="dropdown-item" href="#">Track LR-A</a></li>
