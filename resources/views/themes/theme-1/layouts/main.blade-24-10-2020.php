...
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/themes/theme-1/css/animate.css')}}" />

<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous">
<!-- End magnific-popup- css -->
<link rel="stylesheet" type="text/css" href="{{asset('public/assets/themes/theme-1/css/custom.css')}}" />
...
<script type="text/javascript" src="{{asset('public/assets/themes/theme-1/js/jquery-3.4.1.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/assets/themes/theme-1/js/popper.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('public/assets/themes/theme-1/js/wow.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/assets/themes/theme-1/js/custom.js')}}"></script>
...
$(document).on("click", ".capabityBtn", function(e){
  ...
  $.ajax({
    ...
    success: function(resp){
      if(resp.success) {
        $("#capabilityEnquiry").find(".sccMsg").html('<div class="alert alert-success"> Your Request has been submitted. </div>').delay(3000).fadeOut();;
