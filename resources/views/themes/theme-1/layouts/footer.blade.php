            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 rightLinks expLeftImg">
                  ...
                  <ul class="footerSocialLinks">
                    ...
                    <li><a href="{{$FACEBOOK}}">
                       <i class="round">
                        <span class="home_icon fb_icon"></span>
                  ...
                  <?php } ?>
                    ...
                    <li><a href="{{$LINKEDIN}}">
                      <i class="round">
                        <span class="home_icon link_icon"></span>
                      <!--  <img src="{{asset('assets/themes/theme-1/images/linkedin-icon.png')}}"  alt="linkedin" /></i> -->
                  ...
                  ?>
                    <li><a href="{{$TWITTER}}">
                      <i class="round">
                        <span class="home_icon twi_icon"></span>
                        <!-- <img src="{{asset('assets/themes/theme-1/images/twitter-icon.png')}}" alt="Twitter" /></i> -->
                  ...
                  if(!empty($YOUTUBE)){
                    ...
                    <li><a href="{{$YOUTUBE}}">
                        <i class="round">
                          <span class="home_icon youtube_icon"></span>
                         <!--  <img src="{{asset('assets/themes/theme-1/images/youtube-icon.png')}}" alt="Youtube" /></i> -->
