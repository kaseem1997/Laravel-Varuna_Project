            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 rightLinks expLeftImg">
                  ...
                  <ul class="footerSocialLinks">
                    ...
                    <li><a href="{{$FACEBOOK}}">
                       <i class="round">
                         <img src="{{asset('public/assets/themes/theme-1/images/faceboo-icon.png')}}" alt="" />
                       </i>
                  ...
                  <?php } ?>
                    ...
                    ?>
                    <li><a href="{{$LINKEDIN}}">
                      <i class="round"> <img src="{{asset('public/assets/themes/theme-1/images/linkedin-icon.png')}}" alt="" /></i>
                  ...
                  ?>
                    <li><a href="{{$TWITTER}}">
                      <i class="round"><img src="{{asset('public/assets/themes/theme-1/images/twitter-icon.png')}}" alt="" /></i>
                  ...
                  if(!empty($YOUTUBE)){
                    ?>
                    <li><a href="{{$YOUTUBE}}">
                        <i class="round"><img src="{{asset('public/assets/themes/theme-1/images/youtube-icon.png')}}" alt="" /></i>
