            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 rightLinks expLeftImg">
                  ...
                  <ul class="footerSocialLinks">
                    ...
                    if(!empty($FACEBOOK)){
                    ?>
                    <li><a href="{{$FACEBOOK}}"><i class="fab fa-facebook  round"></i></a></li>
                  <?php } ?>

                    <?php
                    if(!empty($LINKEDIN)){
                    ?>
                    <li><a href="{{$LINKEDIN}}"><i class="fab fa-linkedin  round"></i></a></li>
                  <?php }
                  
                  if(!empty($TWITTER)){
                  ?>
                    <li><a href="{{$TWITTER}}"><i class="fab fa-twitter round"></i></a></li>
                    <?php
                  }

                  if(!empty($YOUTUBE)){
                    ?>
                    <li><a href="{{$YOUTUBE}}"><i class="fab fa-youtube round"></i></a></li>
                  <?php } ?>
                  </ul>
                </div>
              </div>
