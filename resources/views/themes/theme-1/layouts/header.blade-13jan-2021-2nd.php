                 ...
                 <li>
                  ...
                  <ul class="flex_menus">
                    ...
                    <a href="{{url('industry-healthcare')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/M-Pharmacy.png')}}" class="img-fluid" />
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-omnichannel')}}">
                      ...
                      <img src="{{asset('/assets/themes/theme-1/images/M-Omnichannel.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Omnichannel Retail
                      </div>
                  ...
                  <li>
                    <a href="{{url('industry-automotive')}}"  class="">
                       <div class="M__menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/M-Auto-Tyre.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                    ...
                    <a href="{{url('food-beverage')}}"  class="">
                       <div class="M__menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/M-F-B.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Food & Beverage
                      </div>
                    ...
                    <a href="{{url('industry-electrical')}}"  class="">
                       <div class="M__menu__box__yelllow">
                      <img src="{{asset('/assets/themes/theme-1/images/M-Electrical.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        Electrical
                      </div>
                    ...
                    <a href="{{url('industry-fmcg')}}">
                       <div class="M__menu__box__blue">
                      <img src="{{asset('/assets/themes/theme-1/images/M-FMCG.png')}}" class="img-fluid">
                      </div>
                      <div class="menuBoxText">
                        FMCG
                      </div>
