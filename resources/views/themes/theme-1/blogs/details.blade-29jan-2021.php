              ...
              <div class="singleBlogCont">
                  ...
                  <div class="blogShare">
                    <ul>
                      ...
                      <li>
                       <div class="tooltipp">
                         <img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShare.png')}}" />
                      ...
                      <li>
                        <a href="javascript:void(0)" data-id="{{ $blog->id }}" class="print_invoice noPrin"><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPrint.png')}}" /></a>
                      </li>
                      <li>
                        <a href="{{url('insights/download-pdf/'.$blog->id)}}" ><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPDF.png')}}" /></a>
                      </li>
