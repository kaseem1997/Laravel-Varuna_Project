          ...
          <div class="row justify-content-center">
            <div class="col-12 col-sm-5 col-lg-5 col-xl-5 col-md-6">
              <div class="singleBlogCont">
                  ...
                  <h1 class="postBlogHeading"><a href="#" class=""><?php echo $blog->title ?></a></h1>
                  ...
                  <div class="blogShare">
                    <ul>
                      <!-- <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShare.png')}}" /></li> -->
                      <li>
                       <div class="tooltipp">
                         <img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShare.png')}}" alt="Social Share" />
                           ...
                           <ul class="socialShare">
                             ...
                             <li><a href="https://twitter.com/intent/tweet?url=<?php echo url('insights/'.$blog->slug);?>"><i class="fab fa-twitter fabb"></i></a></li>
                              <li>
                                ...
                                <a href="whatsapp://send?text=<?php echo url('insights/'.$blog->slug);?>" data-action="share/whatsapp/share"><i class="fab fabb fa-whatsapp"></i></a>
                              </li>
                           </ul>
                         </span>
                       </div>
                      ...
                      <li>
                        <a href="javascript:void(0)" data-id="{{ $blog->id }}" class="print_invoice noPrin"><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPrint.png')}}" alt="social Print" /></a>
                      </li>
                      <li>
                        <a href="{{url('insights/download-pdf/'.$blog->id)}}" ><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPDF.png')}}"  alt="Social Pdf" /></a>
                      </li>
                      <!-- <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShre.png')}}" /></li> -->
            ...
            <div class="col-12 col-sm-7 col-lg-7 col-xl-7 col-md-6">
              <div class="outerBlogImg">
               <img src="{{$image}}" alt="<?php echo $blog->title ?>" />
             </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-12 col-sm-8 col-lg-8 col-xl-8 col-md-6">
            <div class="singleContentSect olli__display">
               ...
               <!--  <div class="blogShare">
                    <ul>
                      <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShare.png')}}" /></li>
                      <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPrint.png')}}" /></li>
                      <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialPDF.png')}}" /></li>
                      <li><img class="img-fluid roundIcon" src="{{asset('assets/themes/theme-1/images/socialShre.png')}}" /></li>
                    </ul>
                  </div> -->
            </div>
              ...
              <div class="sideBlogBox sideBorderBtm">
                <h6><a href="{{url('insights/'.$r_blog->slug)}}"><?php echo $r_blog->title; ?></a> </h6>
                 <div class="sidebarTimeDate">
                  ...
                  <img src="{{$image}}" alt="<?php echo $r_blog->title; ?>" class="img-fluid" />
              </div><!-- sideBlogBox -->
          <?php } ?>
