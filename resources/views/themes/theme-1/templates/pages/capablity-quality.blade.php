      ...
      <div class="owl-carousel bannerSlider">
        <div class="item">
          <div class="bannerSlWrp">
            <img class="img-fluid" src="{{$banner_image}}" alt="When it comes to our operations & service, Varuna Group follows the best industry practices, prioritising transparency, quality & efficiency.">
