      ...
      <div class="owl-carousel bannerSlider">
        <div class="item">
          <div class="bannerSlWrp">
            <img class="img-fluid" src="{{$banner_image}}" alt="Multi-user warehousing facilities & pay per use warehousing solution ensure customers business goods are stored">
...
<div class="breadcrum">
  ...
  <ul class="breadcrum_list">
    ...
    <a href="{{url('capabilities')}}">Capabilities</a>
     ...
     <li>
    Capability Multi User Facilities
    </li>
  </ul>
</div>
</div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm-8 col-lg-8 col-xl-8 col-md-8 col-12">
        <p>Experience exceptional and flexible warehousing services with Varuna Warehousing.</p>
      </div>
      <div class="col-sm-4 col-lg-4 col-xl-4 col-md-4 col-12">
        <div class="knowMore">
          <a href="{{url('warehousing-management-services')}}">Know more</a>
        </div>
      </div>
    </div>
  </div>
