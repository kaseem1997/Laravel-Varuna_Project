      ...
      <div class="owl-carousel bannerSlider">
        <div class="item">
          <div class="bannerSlWrp">
            <img class="img-fluid" src="{{$banner_image}}" alt="Transform your supply chain into a competitive advantage with our uninterrupted warehousing & logistics services in India.">
