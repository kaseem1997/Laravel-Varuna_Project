				...
				<div class="item">
					<div class="bannerSlWrp">
						...
						<div class="bannerContent container-fluid paddingleftRight">
							<h6 class="yelloHedaing">EMPLOYEE STORIES</h6>
							<p class="whiteText">Get to know the <br /> Varuna family <br /> up close</p>
						</div>
					</div>
				</div>
			</div>
          ...
          <div class="row  justify-content-center">
          	...
          	if(!empty($emp_stories) && count($emp_stories) > 0){
      			...
      			if(!empty($emp_story->image) && $storage->exists('employee_stories/'.$emp_story->image)){
      				$r_image = url('public/storage/employee_stories/'.$emp_story->image);
      			}
          	?>
            <div class="col-sm-5 col-md-5 mt-4 mb-4">
                <div class="leftContEmp">
                <h5 class="landingHeading">{{$emp_story->title}}</h5>
                
                <?php echo $emp_story->brief; ?>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-sm-8 col-lg-8 col-xl-8 col-md-8 col-12">
              <p>Embrace the opportunity to grow</p>
            </div>
