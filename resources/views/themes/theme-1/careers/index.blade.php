        ...
        <div class="row">
          <div class="col-12">
            <div class="owl-carousel bannerSlider">
              <div class="item">
                <div class="bannerSlWrp">
                  <img class="img-fluid" src="/assets/themes/theme-1/images/jop-banner.jpg" alt="Explore the Current Job Openings at Varuna Group">
                  <div class="bannerContent container-fluid paddingleftRight">
...
<section class="knowMoreAbout wow fadeInDown" style="visibility: visible; animation-name: fadeInDown;width: 100%;">
  <div class="container">
    <!-- <div class="row justify-content-center"> -->
      <div class="">
         <p>If you are not able to find a relevant job please <a href="https://cafehrvarunagroup.darwinbox.in/ms/candidate/careers/others?apply=1" target="_blank">click here</a> to post your resume.</p>
...
if(isset($_GET['location']) || isset($_GET['department']) || isset($_GET['experience'])) {
?>
