        ...
        <div class="row">
          <div class="col-12">
            <div class="owl-carousel bannerSlider">
              <div class="item">
                <div class="bannerSlWrp">
                  <img class="img-fluid" src="https://www.varuna.ehostinguk.com/public/storage/cms_pages/051020090912-rsz_1our_journey_banner-02.png" alt="">
                  <div class="bannerContent container-fluid paddingleftRight">
                    <h6 class="yelloHedaing">JOB OPENINGS</h6>
                    <p class="whiteText">Do thebest work <br>of your life</p>
                  </div>
                </div>
              </div>
            </div>
           ...
           <div class="col-sm-3">
            <div class="form-group">
              ...
              <select class="form-control">
                <option>Select Experience of Years</option>
