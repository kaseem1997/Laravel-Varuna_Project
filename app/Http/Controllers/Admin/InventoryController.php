...
class InventoryController extends Controller {
    ...
    public function store(Request $request, $product)
    {
        ...
        if ($createdInventory) {
            ...
            return redirect(route('admin.products.show', $product['id']))->with('alert-success', 'The product inventory item has been added successfully.');
        } else {
    ...
    public function update(Request $request, $product, $inventoryItem) {
        ...
        return redirect(route('admin.products.show', $inventoryItem->product['id']))->with('alert-success', 'The product inventory item has been updated successfully.');
    }
    ...
    public function destroy($product, $inventoryItem)
    {
        ...
        return redirect(route('admin.products.show', $product['id']))->with('alert-success', 'The product inventory item has been removed successfully.');
    }
